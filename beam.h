...
public:
  ...
  */
    ...
    /**
      * Adds a round segment to the beam with the specified radius, length, and force.
      *
...
private:
    ...
    {
    public:
        Segment( double lenght, double moment )
            : length( lenght ), moment( moment ) {}
        double length;
        double area;
        double moment;
        double momentOfInertia;
        double momentOfResistance;
        double segmentMoment;
        double twistAngle;
    ...
    public:
        RoundSegment( double length, double size, double moment, double m )
            : Segment( length, moment ), diameter( size ), m (m) {}
        double diameter;
        double m;
    ...
    public:
        RectangularSegment( double length, double size, double moment, double m, double formSech )
            : Segment( length, moment ), width( size ), m ( m ), formSech( formSech ) {}
        double width;
        double m;
        double formSech;
        double angles[13][3]{ {1, 0.208, 0.140}, {1.2, 0.219, 0.166}, {1.4, 0.228, 0.187},
                              ...
                              {6, 0.299, 0.299}, {8, 0.307, 0.307}, {10, 0.313, 0.313}, {0, 0.333, 0.333} };
        double GetMomentOfInertia() const override
        {
            double beta{};
            for (int i = 0; i<13; i++)
    ...
    public:
        PipeSegment( double length, double size, double moment, double m, double formSech )
            : Segment( length, moment ), diameter( size ), m ( m ), formSech( formSech ) {}
        double diameter;
        double m;
        double formSech;
        double GetMomentOfInertia() const override
