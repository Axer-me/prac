...
public:
  ...
  */
    ...
    /**
      * Checks segment shapes to match either Circle, Rectangle or Pipe.
      */
    void SegmentShapeCheck();
...
private:
    ...
    public:
        ...
        double GetMomentOfInertia() const override
        {
            double c = (1 - pow(formSech, 4)) / 32;
            double b = M_PI * pow(diameter,4);
            double a = c * b;
        ...
        double GetMomentOfResistance() const override
        {
            double c = (1 - pow(formSech, 3)) / 16;
            double b = M_PI * pow(diameter,3);
            double a = c * b;
            return (a);
        }
        SegmentShape GetShape() const override
